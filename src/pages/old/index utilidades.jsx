    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 3 }}>
        <Typography variant="h4" gutterBottom color="primary">
          🧪 Sistema de Refinanciación con Liquidación y Utilidades
        </Typography>
        <Typography variant="body2" color="text.secondary" paragraph>
          Sistema mejorado con cálculo de 3 tipos de utilidades
        </Typography>
      ...
      <Paper elevation={1} sx={{ p: 2, mt: 3, backgroundColor: 'grey.100' }}>
        ...
        <Typography variant="body2" component="div">
          <strong>El sistema calcula 3 tipos de utilidades:</strong>
          <ul>
            <li><strong>Utilidad 1:</strong> Ganancia total inmediata (se registra al crear el préstamo)</li>
            <li><strong>Utilidad 2:</strong> Ganancia distribuida por cuotas (se genera mes a mes)</li>
            <li><strong>Utilidad 3:</strong> Ganancia después de recuperar el capital (ganancia neta real)</li>
          </ul>
          
          <strong>Ejemplo con $1.000.000 al 10% por 10 meses:</strong>
          <ul>
            <li>Total a pagar: $2.000.000</li>
            <li>Utilidad 1: $1.000.000 (registrada inmediatamente)</li>
            <li>Utilidad 2: Se acumula con cada cuota pagada</li>
            <li>Utilidad 3: Empieza después de recibir $1.000.000 en pagos</li>
          </ul>
        </Typography>
      </Paper>
    </Container>
