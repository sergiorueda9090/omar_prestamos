    ...
    <Dialog open={open} onClose={handleCerrar} maxWidth="md" fullWidth>
      ...
      <DialogActions sx={{ p: 2 }}>
        ...
        <Button 
          ...
          variant="contained" 
          color="success"
          disabled={!montoPago || parseMoney(montoPago) <= 0 || (tipoPago !== 'interes' && distribucion.length === 0)}
        >
          Confirmar Pago
        </Button>
      </DialogActions>
...
const ClientesTest = () => {
  ...
  // ACTUALIZADO: Aplicar pago flexible con distribución (con soporte para interés)
  const handleAplicarPago = (monto, distribucion, tipoPago) => {
