    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Paper elevation={1} sx={{ p: 2, mt: 3, backgroundColor: 'grey.100' }}>
        ...
        <Typography variant="body2" component="div">
          <ol>
            <li>Configure el préstamo inicial (ej: $1.000.000, 5%, 10 meses) → Cuota: $150.000</li>
            <li>Genere el plan de cuotas</li>
            <li>En la pestaña "Gestión", marque algunas cuotas como pagadas (ej: 2 cuotas = $300.000)</li>
            <li>Al hacer clic en "Iniciar Ampliación", se abrirá el diálogo de liquidación</li>
            <li>El sistema calculará el interés de liquidación y lo restará del total pagado</li>
            <li>El saldo a favor resultante se aplicará automáticamente a las primeras cuotas del nuevo plan</li>
          </ol>
        </Typography>
        <Divider sx={{ my: 1 }} />
        <Typography variant="caption" color="text.secondary">
          <strong>Ejemplo:</strong> Total pagado: $300.000 - Interés liquidación: $50.000 = Saldo a favor: $250.000 
          (se abona a las primeras cuotas de la ampliación)
        </Typography>
      </Paper>
    </Container>
  );
